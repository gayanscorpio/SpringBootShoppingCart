...
public class JwtUtil {
	...
	public JwtUtil() {
		try {
			// In production, src/main/resources is inside your JAR, not a file path.
			String key = new String(new ClassPathResource("public.key").getInputStream().readAllBytes(),
					StandardCharsets.UTF_8).replace("-----BEGIN PUBLIC KEY-----", "")
